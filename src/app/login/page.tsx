      ...
      >
        <section className="relative hidden min-h-[590px] overflow-hidden border-l border-white/[0.08] p-8 md:grid md:place-items-center">
          ...
          <div className="relative text-center">
            ...
            <h1 className="altahaddi-page-title mt-6 font-black">رجعت للتحدي</h1>
            <p className="altahaddi-body-copy mx-auto mt-3 max-w-sm font-semibold text-white/58">كل بطولاتك، توقعاتك وألعابك في حساب واحد.</p>
          </div>
        </section>
        ...
        <section className="p-4 sm:p-6 md:p-8 lg:p-10">
          ...
          <p className="altahaddi-eyebrow font-black text-[var(--brand-yellow)]">تسجيل الدخول</p>
          <h2 className="altahaddi-page-title mt-1 font-black">كمل منافستك</h2>
          <p className="altahaddi-body-copy mt-2 font-semibold text-white/52">ادخل بالطريقة المعتادة أو استخدم حسابك المفضل.</p>
