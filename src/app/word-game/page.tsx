    ...
    >
      ...
      <section className="relative mx-auto max-w-4xl px-3 py-4 md:px-4 md:py-6">
        <motion.div
          ...
          whileTap={{ scale: 0.99 }}
          className="relative mb-4 overflow-hidden rounded-3xl border border-white/10 bg-white/10 p-4 text-center shadow-2xl shadow-slate-950/30 backdrop-blur-xl md:p-5"
        >
          ...
          <div className="relative">
            <motion.div
              ...
              className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-3xl border border-amber-300/25 bg-amber-300/10 text-amber-200 shadow-lg shadow-amber-950/20"
            >
