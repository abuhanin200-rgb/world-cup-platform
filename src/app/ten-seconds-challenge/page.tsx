...
function ChallengeNavButton({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      whileTap={{ scale: 0.97 }}
      className={`inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl border px-3 py-3 text-[12px] font-black shadow-md transition md:px-5 md:text-sm ${toneClass}`}
    >
      {children}
    </motion.button>
  );
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 inline-flex items-center gap-1 text-[10px] text-slate-300 md:text-sm">
                <Clock3 className="h-3 w-3 text-amber-300 md:h-4 md:w-4" />
                <span>تحدي العشر ثواني</span>
              </p>
            </div>
          </motion.div>
      ...
      <section className="relative mx-auto max-w-6xl px-3 py-4 md:px-4 md:py-6">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="mb-4 inline-flex items-center justify-center gap-2 text-[24px] font-black leading-snug md:text-4xl">
              <span>تحدي العشر ثواني</span>
              <Sparkles className="h-5 w-5 text-amber-300 md:h-7 md:w-7" />
            </h2>

            <div className="mt-4 grid grid-cols-2 gap-2 md:mt-5 md:flex md:flex-row md:justify-center md:gap-3">
              <ChallengeNavButton
                tone="amber"
