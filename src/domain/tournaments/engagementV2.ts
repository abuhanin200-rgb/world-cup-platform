...
export const GULF_CUP_27_ACHIEVEMENTS: readonly TournamentAchievementDefinitionV2[] = [
  { key: "first_exact", title: "أول إصابة بالملي", description: "أصاب أول نتيجة دقيقة في خليجي الديار العربية 27.", badge: "🎯", rarity: "common" },
  ...
  { key: "champion", title: "بطل خليجي الديار العربية 27", description: "أنهى البطولة في المركز الأول.", badge: "🏆", rarity: "legendary" },
] as const;
