...
export const GULF_CUP_27_PREDICTION_OPEN_LEAD_MS = 3 * 24 * 60 * 60 * 1000;
...
function groupMatch(
  ...
  return {
    ...
    city: "جدة",
    status: "scheduled",
    predictionOpensAt: new Date(iso).getTime() - GULF_CUP_27_PREDICTION_OPEN_LEAD_MS,
    predictionClosesAt: new Date(iso).getTime(),
...
function knockoutMatch({
  ...
  return {
    ...
    awaySourceLabel,
    kickoffAt: new Date(iso).getTime(),
    stadium: id === "g27-sf-1" ? "استاد مدينة الملك عبدالله الرياضية" : id === "g27-sf-2" ? "استاد الأمير عبدالله الفيصل" : "استاد مدينة الملك عبدالله الرياضية",
    city: "جدة",
    status: "scheduled",
    predictionOpensAt: new Date(iso).getTime() - GULF_CUP_27_PREDICTION_OPEN_LEAD_MS,
    predictionClosesAt: new Date(iso).getTime(),
...
export const GULF_CUP_27_GROUP_MATCHES: readonly TournamentMatchV2[] = [
  ...
  groupMatch("g27-b-r1-uae-yem", "الجولة 1", "B", "uae", "yem", "2026-09-24T18:55:00+03:00", "استاد مدينة الملك عبدالله الرياضية"),
  groupMatch("g27-b-r1-qat-bhr", "الجولة 1", "B", "qat", "bhr", "2026-09-24T21:00:00+03:00", "استاد الأمير عبدالله الفيصل"),
  groupMatch("g27-a-r2-kuw-irq", "الجولة 2", "A", "kuw", "irq", "2026-09-26T18:55:00+03:00", "استاد الأمير عبدالله الفيصل"),
  groupMatch("g27-a-r2-ksa-oma", "الجولة 2", "A", "oma", "ksa", "2026-09-26T21:00:00+03:00", "استاد مدينة الملك عبدالله الرياضية"),
  groupMatch("g27-b-r2-yem-qat", "الجولة 2", "B", "yem", "qat", "2026-09-27T18:55:00+03:00", "استاد مدينة الملك عبدالله الرياضية"),
  groupMatch("g27-b-r2-uae-bhr", "الجولة 2", "B", "bhr", "uae", "2026-09-27T21:00:00+03:00", "استاد الأمير عبدالله الفيصل"),
