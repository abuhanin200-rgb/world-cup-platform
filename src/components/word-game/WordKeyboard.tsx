...
function getKeyClass(status: WordGameTileStatus | undefined) {
  ...
  if (status === "present") return "border-amber-300 bg-amber-400 text-slate-950";
  if (status === "absent") return "border-slate-700 bg-slate-800/60 text-slate-500 opacity-45";
