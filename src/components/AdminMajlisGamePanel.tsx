...
type QuestionDraft = {
  ...
  type: MajlisQuestionType; audioUrl: string; audioMaxSeconds: number; reciterName: string; enabled: boolean; custom: boolean;
};
...
const EMPTY_QUESTION: QuestionDraft = { id: "", categoryId: "", groupKey: "", prompt: "", answer: "", optionsText: "", difficulty: "medium", points: 200, hint: "", explanation: "", sourceLabel: "", type: "text", audioUrl: "", audioMaxSeconds: 12, reciterName: "", enabled: true, custom: true };
...
function questionDraft(question?: MajlisQuestion): QuestionDraft {
  ...
  return {
    ...
    explanation: question.explanation || "", sourceLabel: question.sourceLabel || "", type: question.type, audioUrl: question.audioUrl || "",
    audioMaxSeconds: question.audioMaxSeconds || 12, reciterName: question.reciterName || "", enabled: question.enabled, custom: question.custom === true,
  };
}
