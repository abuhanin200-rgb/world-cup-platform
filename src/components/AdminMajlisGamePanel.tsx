...
type QuestionDraft = {
  id: string; categoryId: string; groupKey: string; family: string; prompt: string; answer: string; optionsText: string;
...
const EMPTY_QUESTION: QuestionDraft = { id: "", categoryId: "", groupKey: "", family: "", prompt: "", answer: "", optionsText: "", difficulty: "hard", points: 300, hint: "", explanation: "", sourceLabel: "", type: "text", quoteText: "", speechText: "", speechLang: "", audioUrl: "", audioFallbackUrl: "", audioStartSeconds: 0, audioMaxSeconds: 15, reciterName: "", enabled: true, custom: true };
...
function questionDraft(question?: MajlisQuestion): QuestionDraft {
  ...
  return {
    id: question.id, categoryId: question.categoryId, groupKey: question.groupKey, family: question.family || "", prompt: question.prompt, answer: question.answer,
