...
export default function TournamentCard({ tournament }: TournamentCardProps) {
  ...
  return (
    <Link
      ...
      className="altahaddi-glass group relative isolate min-h-[300px] overflow-hidden rounded-[28px] text-[var(--tournament-text)] outline-none transition duration-300 hover:-translate-y-1 hover:border-white/25 focus-visible:ring-2 focus-visible:ring-[var(--tournament-primary)] active:scale-[0.99] md:min-h-[360px] md:rounded-[34px]"
    ...
    >
      ...
      <div className="relative flex min-h-[300px] flex-col justify-between p-4 md:min-h-[360px] md:p-5">
