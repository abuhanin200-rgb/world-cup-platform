...
function GulfRulesSection() {
  ...
  return <div className="space-y-4">
    <div className="grid gap-3 md:grid-cols-2">
      ...
      <RuleCard icon={<Scale className="h-5 w-5" aria-hidden="true" />} title="حسم تساوي الأعضاء"><p>الترتيب حسب مجموع نقاط البطولة، ثم عدد النتائج بالملي، ثم الفائز الصحيح، ثم عدد التوقعات الأعلى، ثم الأقل أخطاء، وأخيرًا الاسم.</p></RuleCard>
